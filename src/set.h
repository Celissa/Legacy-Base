...
template < class T >
bool process( T* field, char_data* ch, const char* subject, const char* argument, species_data* species, player_data* player )
{
  const char*  response;
...
template < class T >
bool process( T* field, char_data* ch, const char* subject, const char* argument, species_data* species )
{
...
template < class T >
bool process( T* field, char_data* ch, const char* subject, const char* argument, obj_clss_data* obj )
{
  const char*  response;
...
void set_string   ( char_data*, const char*, char*&, const char*, int );
void set_type     ( char_data*, const char*, int&, const char*, const char*, int, const char**, const char** = NULL );
