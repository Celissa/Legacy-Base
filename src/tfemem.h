...
#define MEM_MRESET                 34   // MEM_RESET defined in winnt.h
#define MEM_ROOM                   35
#define MEM_SHDATA                 36
#define MEM_SHOP                   37
#define MEM_SPECIES                38
#define MEM_SPELL                  39
#define MEM_STRING                 40
#define MEM_TABLE                  41
#define MEM_TELL                   42
#define MEM_TRACK                  43
#define MEM_TRAINER                44
#define MEM_WIZARD                 45
#define MEM_TPROG                  46
#define MAX_MEMORY                 47
...
char*  alloc_string       ( const int, int );
