...
class Program_Data
{
 public:
  ...
  Program_Data( template_data* aowner ) {
...
#define TRIGGER_UNTRAP_DOOR        14
#define TRIGGER_GET                15
#define TRIGGER_REPOP              16
#define TRIGGER_SCAN               17
#define TRIGGER_CLIMB              18
#define TRIGGER_RDESC              19
#define MAX_ATN_TRIGGER            20
...
class Action_Data : public program_data
{
 public:
  ...
  Action_Data( template_data* aowner ) : Program_Data( aowner ) {
...
#define MPROG_TRIGGER_GIVE_TYPE    13
#define MPROG_TRIGGER_ABANDON      14
#define MPROG_TRIGGER_PRACTICE     15
#define MPROG_TRIGGER_RANDOM       16
#define MPROG_TRIGGER_TAME         17
#define MAX_MPROG_TRIGGER          18
...
class Mprog_Data : public program_data
{
 public:
  ...
  Mprog_Data( template_data* aowner ) : Program_Data( aowner ) {
...
#define OPROG_TRIGGER_AFTER_USE     8
...
#define OPROG_TRIGGER_UNUSED       15
#define MAX_OPROG_TRIGGER          16
...
class Oprog_Data : public program_data
{
 public:
  ...
  Oprog_Data( template_data* aowner ) : Program_Data( aowner ) {
...
class Tprog_Data : public program_data
{
 public:
   ...
   Tprog_Data( template_data* aowner ) : Program_Data( aowner ) {
     record_new( sizeof( tprog_data ), MEM_TPROG );
     obj_act    = NULL;
     obj_vnum   = 0;
     value      = -1;
     obj_clss   = NULL;
   ...
   ~Tprog_Data( ) {
     record_delete( sizeof( tprog_data ), MEM_TPROG );
   }
...
bool   search_cflag       ( arg_type*, int );
bool   search_progs       ( arg_type*, int, arg_enum );
bool   search_progs       ( arg_type*, cfunc*, bool );
bool   cfunc_search       ( char_data*, cfunc*, bool );
extern bool execute_use_trigger( char_data*, obj_data*, int );
