...
class Pc_Data
{
 public:
  ...
  int              wimpy;
  int              skill        [ MAX_SKILL ];
  int         core_skill        [ MAX_NEW_SKILL ];
  int         core_usage        [ MAX_NEW_SKILL ];
  int        class_skill        [ MAX_NEW_SKILL ];
  int        class_usage        [ MAX_NEW_SKILL ];
  int              skill_usage  [ MAX_SKILL ];
  Note_Data*       mail_edit;
  pfile_data*      pfile;
...
player_data* link_player     ( char_data* );
