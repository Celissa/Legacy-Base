...
#define CON_READ_ABOUT             22
#define CON_READ_IMOTD             23
#define CON_READ_MOTD              24
#define CON_CLOSING_LINK           25
#define CON_CE_ACCOUNT             26
#define CON_CE_PASSWORD            27
#define CON_CE_EMAIL               28
#define CON_VE_ACCOUNT             29
#define CON_VE_VALIDATE            30
#define CON_VE_CONFIRM             31
...
extern socket_t socket_one;

extern link_array    host_stack;
extern int           read_pntr;

extern int bytes_written;
extern int gigs_written;
...
void   nanny_about              ( link_data*, char* );
